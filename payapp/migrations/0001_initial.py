# Generated by Django 5.0.1 on 2024-04-21 08:29
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('account', '0009_alter_kyc_identity_image'),
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('transaction_type', models.CharField(choices=[('transfer', 'Transfer'), ('received', 'Receive'), ('withdraw', 'Withdraw'), ('refund', 'Refund'), ('request', 'Request'), ('none', 'None')], default='none', max_length=100)),
